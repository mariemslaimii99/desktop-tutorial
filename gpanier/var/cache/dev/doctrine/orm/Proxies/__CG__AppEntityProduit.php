...
class Produit extends \App\Entity\Produit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'photo', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'prix', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'commandes'];
        }
     ...
     * {@inheritDoc}
     */
    public function addCommandes(\App\Entity\Commande $commandes): \App\Entity\Produit
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCommandes', [$commandes]);

        return parent::addCommandes($commandes);
    }

    /**
     * {@inheritDoc}
     */
    public function removeCommandes(\App\Entity\Commande $commandes): \App\Entity\Produit
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCommandes', [$commandes]);

        return parent::removeCommandes($commandes);
    }
